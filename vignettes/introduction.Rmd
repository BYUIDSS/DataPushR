...
```{r, echo=FALSE}
package_path <- read_rds("/Users/hathawayj/git/byuidss/DataPushR/ppath")
```


The `usethis` package allows us to set the project folder where there functions will be executed.  We will use this to create the R data objects for use in the R package
